...
export const Navbar = () => {
    ...
    const cv_file_url = "/pdf/Sefa_Uygun_CV.pdf";
    ...
    return (
        <nav
            ref={refHead}
            className={`bg-gradient-to-r from-black via-gray-900 to-black bg-opacity-70 backdrop-blur-md fixed top-0 left-0 w-full z-50 shadow-lg transition duration-300 ease-in-out pt-2 ${isScrolled ? "navbar-fixed" : " "
                }`}>
            <div className="container mx-auto px-4 flex items-center justify-between">
                ...
                <div className="lg:hidden flex items-center">
                    <button
                        ...
                        <div
                            className={`hamburger-line ${isMenuOpen ? "rotate-45" : ""}`}></div>
                        <div
                            className={`hamburger-line ${isMenuOpen ? "opacity-0" : "opacity-100"}`}></div>
